"""Surface3D PoC demos — writes self-contained HTML you can open in a browser.
    ...
    python support/surface_demo.py
        -> support/surface_iv.html   (synthetic equity implied-vol surface)
        -> support/surface_bs.html   (Black-Scholes call-price surface)
...
_ROOT = Path(__file__).resolve().parent.parent      # repo root (support/ -> ..)
sys.path.insert(0, str(_ROOT / "src"))
from signum.engine.surface3d import Surface3D  # noqa: E402

_OUT = Path(__file__).resolve().parent              # write HTML next to this script (support/)
